...
<div class="encuadre">
	...
	<p>Este es el ejemplo de uno de los distintos usos de esta etiqueta: </p>
	...
	<h1>Los distintos atributos de la etiqueta &ltinput&gt</h1>
		...
		<h2>type="number"</h2>
			...
			<pre>&lt;input type="number"&gt;&lt;/input&gt;</pre>
			<p>El resultado: </p>
		...
		<h2>type="email"</h2>
			...
			<pre>&lt;input type="email"&gt;&lt;/input&gt;</pre>
			<p>El resultado: </p>
		...
		<h2>type="password"</h2>
			...
			<pre>&lt;input type="password"&gt;&lt;/input&gt;</pre>
			<p>El resultado: </p>
		...
		<h2>size="tamaño de la caja"</h2>
			...
			<pre>&lt;input type="text" size="40"&gt;&lt;/input&gt;</pre>
			<p>El resultado: </p>
		...
		<h2>maxlength="límite de caracteres"</h2>
			...
			<pre>&lt;input type="text" maxlength="10"&gt;&lt;/input&gt;</pre>
			<p>El resultado: </p>
		...
		<h2>value="texto ya escrito"</h2>
			...
			<pre>&lt;input type="text" value="texto ya escrito"&gt;&lt;/input&gt;</pre>
			<p>El resultado: </p>
		...
		<h2>placeholder="¿De qué trata el cuadro?"</h2>
			...
			<pre>&lt;input type="text" placeholder="¿De qué trata el cuadro?"&gt;&lt;/input&gt;</pre>
			<p>El resultado: </p>
		...
		<h2>name="nombre-identificatorio-del-input"</h2>
			...
			<pre>&lt;input type="text" name="nombre-del-cuadro"&gt;&lt;/input&gt;</pre>
			<br><br>
	...
	<h1>Usando &ltinput&gt para seleccionar datos predeterminados</h1>
		...
		<h2>Selección múltiple: type="checkbox"</h2>
			...
			<pre>
			&lt;input type="checkbox" name="seccion3" value="valor1"&gt;&lt;/input&gt;&lt;br /&gt;
			&lt;input type="checkbox" name="seccion3" value="valor2"&gt;&lt;/input&gt;&lt;br /&gt;
			&lt;input type="checkbox" name="seccion3" value="valor3"&gt;&lt;/input&gt;&lt;br /&gt;
			</pre>
			<p>El resultado: </p>
